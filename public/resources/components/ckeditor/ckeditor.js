...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("pagebreak", {requires: "fakeobjects", onLoad: function () {
            ...
            a.blockless || (a.addCommand("pagebreak", CKEDITOR.plugins.pagebreakCmd), a.ui.addButton && a.ui.addButton("PageBreak", {label: a.lang.pagebreak.toolbar, command: "pagebreak", toolbar: "insert,70"}), (CKEDITOR.env.opera || CKEDITOR.env.webkit) && a.on("contentDom", function () {
